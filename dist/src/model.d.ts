...
import { CollectionOfferInput as ApiCollectionOfferInput, CollectionSignedOfferInput, LoanSortInput, LoanStatusType, MarketplaceEnum, OffersSortInput, OfferStatus, RenegotiationOfferInput as ApiRenegotiationInput, SignedRenegotiationOfferInput, SingleNftOfferInput as ApiSingleNftOfferInput, SingleNftSignedOfferInput, TermsFilter, UserFilter } from './generated/graphql';
import { Optional } from './utils/types';
type MaxSeniorRepaymentArg = {
    maxSeniorRepayment: Exclude<ApiSingleNftOfferInput['maxSeniorRepayment'], null | undefined>;
};
export type SingleNftOfferInput = Optional<ApiSingleNftOfferInput, 'borrowerAddress' | 'lenderAddress' | 'signerAddress' | 'offerValidators' | 'contractAddress'> & MaxSeniorRepaymentArg;
...
export type SingleNftOffer = UnsignedSingleNftOffer & SingleNftSignedOfferInput & {
    signature: Hash;
} & MaxSeniorRepaymentArg;
export type CollectionOfferInput = Optional<ApiCollectionOfferInput, 'borrowerAddress' | 'lenderAddress' | 'signerAddress' | 'offerValidators' | 'contractAddress'> & MaxSeniorRepaymentArg;
export type UnsignedCollectionOffer = Omit<CollectionSignedOfferInput, 'signature' | 'collectionId'> & {
    nftCollateralAddress: Address;
};
...
/** @ignore */
export declare const MAX_NUMBER = 115792089237316195423570985008687907853269984665640564039457584007913129639935n;
